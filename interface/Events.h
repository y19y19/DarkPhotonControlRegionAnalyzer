...
// Tue Nov 10 15:39:07 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: /uscms/home/yyao/eos/NanoAODv7/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_RunIISummer16_NANOAOD_v1/201018_195803/0000/nano_1.root
//////////////////////////////////////////////////////////
...
public :
   ...
   void    Begin(TTree *outputTree);
   //virtual void    SlaveBegin(TTree *tree);
   void    Init(TTree *tree);
   Bool_t  Notify();
   Bool_t  Process(Long64_t entry);
   Int_t   GetEntry(Long64_t entry, Int_t getall = 0) { return fChain ? fChain->GetTree()->GetEntry(entry, getall) : 0; }
   void    Loop(TTree *outputTree);
   std::pair<bool,std::array<int,2>>   FindMuonPair(Long64_t entry);
   std::pair<bool,int>                 FindCRJet(Long64_t, TLorentzVector m1, TLorentzVector m2);
   bool    JetInFSRRegion(float MuMuMass, float MuMuJetMass);
   bool    JetInCRRegion(float MuMuMass, float MuMuJetMass);
   ...
   Float_t Weight,puWeight,leadingMuPt,leadingMuEta,leadingMuPhi,leadingMuMass,subleadingMuPt,subleadingMuEta,subleadingMuPhi,subleadingMuMass,MuMuMass,MuMuJetMass,deltaR_MuMu,deltaR_leadingMu_jet,deltaR_subleadingMu_jet,jet_electronEnergyFraction,jet_muonEnergyFraction,jet_n90,jet_chargedHadronMultiplicity,jet_chargedMultiplicity,jet_n60,jet_neutralHadronMultiplicity,jet_neutralMultiplicity,jet_nConstituents,jet_pt,jet_chargedEmEnergyFraction,jet_chargedHadronEnergyFraction,jet_neutralEmEnergyFraction,jet_neutralHadronEnergyFraction,jet_et,jet_eta,jet_phi,jet_PtSumOfNeutralHadron,jet_PtSumOfChargedHadron;
   ...
   TTreeReaderArray<Float_t> Jet_PtSumOfChargedHadrons = {fReader, "Jet_PtSumOfChargedHadrons"};
   TTreeReaderArray<Float_t> Jet_PtSumOfNeutralHadrons = {fReader, "Jet_PtSumOfNeutralHadrons"};
   ...
   TTreeReaderArray<Float_t> Jet_chEmE = {fReader, "Jet_chEmE"};
   ...
   TTreeReaderArray<Float_t> Jet_chHE = {fReader, "Jet_chHE"};
   TTreeReaderArray<Float_t> Jet_chHEF = {fReader, "Jet_chHEF"};
   TTreeReaderArray<Float_t> Jet_e = {fReader, "Jet_e"};
   TTreeReaderArray<Float_t> Jet_electronE = {fReader, "Jet_electronE"};
   TTreeReaderArray<Float_t> Jet_electronEF = {fReader, "Jet_electronEF"};
   TTreeReaderArray<Float_t> Jet_eta = {fReader, "Jet_eta"};
   TTreeReaderArray<Float_t> Jet_mass = {fReader, "Jet_mass"};
   TTreeReaderArray<Float_t> Jet_muonE = {fReader, "Jet_muonE"};
   TTreeReaderArray<Float_t> Jet_muonEF = {fReader, "Jet_muonEF"};
   TTreeReaderArray<Float_t> Jet_muonSubtrFactor = {fReader, "Jet_muonSubtrFactor"};
   TTreeReaderArray<Float_t> Jet_neEmE = {fReader, "Jet_neEmE"};
   TTreeReaderArray<Float_t> Jet_neEmEF = {fReader, "Jet_neEmEF"};
   TTreeReaderArray<Float_t> Jet_neHE = {fReader, "Jet_neHE"};
   TTreeReaderArray<Float_t> Jet_neHEF = {fReader, "Jet_neHEF"};
   TTreeReaderArray<Float_t> Jet_phi = {fReader, "Jet_phi"};
   TTreeReaderArray<Float_t> Jet_photonE = {fReader, "Jet_photonE"};
   TTreeReaderArray<Float_t> Jet_photonEF = {fReader, "Jet_photonEF"};
   ...
   TTreeReaderArray<Int_t> Jet_chHMP = {fReader, "Jet_chHMP"};
   TTreeReaderArray<Int_t> Jet_chMP = {fReader, "Jet_chMP"};
   ...
   TTreeReaderArray<Int_t> Jet_electronMP = {fReader, "Jet_electronMP"};
   ...
   TTreeReaderArray<Int_t> Jet_muonMP = {fReader, "Jet_muonMP"};
   TTreeReaderArray<Int_t> Jet_n60 = {fReader, "Jet_n60"};
   TTreeReaderArray<Int_t> Jet_n90 = {fReader, "Jet_n90"};
   ...
   TTreeReaderArray<Int_t> Jet_neHMP = {fReader, "Jet_neHMP"};
   TTreeReaderArray<Int_t> Jet_neMP = {fReader, "Jet_neMP"};
   TTreeReaderArray<Int_t> Jet_photonMP = {fReader, "Jet_photonMP"};
